...
class Singleton:
    ...
    def get_instance(cls):
        '''This design pattern ensures that a class has only one instance throughout the application's runtime, and provides a global access point to that instance.'''
